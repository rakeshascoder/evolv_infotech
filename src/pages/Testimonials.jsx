...
import RedBlur from "../assets/PNG/red_BgBlur.png";
        ...
        <>
            ...
            <div className="lg:py-[100px] md:py-[50px] py-[40px] relative overflow-hidden">
                ...
                <div className="max-w-[1360px] px-3 mx-auto">
                    ...
                    <p className="font_outfit font-normal md:text-[35px] text-[25px] lg:text-[48px] lg:leading-[59px] text-center text-[#000000] lg:mt-[30px] mt-[20px]">"Real Stories of Impact and Trust"</p>
                    <p className="font_outfit font-[300] text-[14px] leading-[14px] text-[#00000099] lg:w-[56%] md:w-[70%] w-[100%] text-center m-auto lg:mt-[30px] mt-[20px]">
                    ...
                    <div className="flex flex-row flex-wrap items-center justify-center  mt-[30px]">
                        ...
                        <div className="xl:w-4/12 md:w-12/12 px-5 sm:w-11/12  mt-[20px] xl:mt-0 w-12/12">
