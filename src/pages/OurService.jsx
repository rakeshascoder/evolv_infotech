          ...
          <div className="flex flex-wrap px-[-12px] flex-row justify-between">
            ...
            <div className="w-full md:w-7/12 px-3 xl:ps-[88px] mt-5 md:mt-0">
              ...
              <p className="font-normal font_outfit text-[10px] lg:text-sm  opacity-60 text-black mt-4  xl:mt-[50px]">
                ...
                viverra a auctor quis ipsum integer placerat. Lorem ipsum dolor
                sit amet consectetur. Imperdiet vulputate enim tortor nulla
                facilisi magna. Aenean ac commodo nisi vitae.
              </p>
