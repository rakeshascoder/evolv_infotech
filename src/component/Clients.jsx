        ...
        <div className="bg-[#000000] lg:py-[100px] md:py-[50px] py-[40px]">
            <div className="max-w-[1360px] px-3 mx-auto">
                ...
                <div className="flex  justify-center items-center">
                    ...
                    <p className=" font_inter font-normal text-[20px] leading-[26px] text-[#FFFFFF]">TESTIMONIAL</p>
                </div>
                ...
                <p className="font_inter font-normal text-[14px] leading-[14px] text-[#FFFFFF99] lg:w-[56%] md:w-[70%] w-[100%] text-center m-auto lg:mt-[30px] mt-[20px]">
                ...
                <div className="flex flex-row flex-wrap items-center justify-center  mt-[30px]">
                    ...
                    <div className="xl:w-2/12 md:w-3/12 sm:w-11/12 w-12/12 px-3 sm:px-0">
                        <div className="bg-[white] rounded-[7px] sm:py-[30px] py-[30px] md:py-[30px] lg:py-[40px] xl:py-[20px] px-[20px] hover:bg-[#06579C] hover:text-[white] duration-300 cursor-pointer">
                            ...
                            <p className="font_inter font-normal text-[14px] leading-[16px]  mt-[10px]">
