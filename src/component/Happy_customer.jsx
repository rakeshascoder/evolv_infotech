    ...
    return <div>
        <div className="bg-[#164343] lg:py-[100px] md:py-[50px] py-[40px]">
            <div className="max-w-[1360px] px-3 mx-auto ">
                <div>
                    <p className="font_jomolhari font-normal lg:text-[48px] md:text-[35px] text-[30px] lg:leading-[62px] lg:w-[70%] sm:w-[80%] w-[100%] text-[#FFFFFF] text-center m-auto">We have more than 270+ Happy Customers with satisfaction</p>
                    <p className="font_inter font-normal leading-[16px] text-[#FFFFFF99] lg:w-[45%] sm:w-[60%]  text-center  m-auto lg:mt-[30px] mt-[20px]">
