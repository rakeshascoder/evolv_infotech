...
function Header({  title, about, span }) {
  ...
  return (
    <>
      <div
        className={`${location.pathname === "/aboutUs" ? "header_bg_image" :location.pathname === "/ourService"?"ourServie_bg_image":location.pathname === "/testimonials"?"testimonials_bg_image bg-cover xl:bg-contain":location.pathname === "/clints"?"clints_bg_image":""} h-[260px] sm:h-[300px] md:h-[360px] lg:h-[450px] absolute top-[0px] w-full -z-[1] `}
      >
